...
def cross_all_bytes2(texts_out, byte_num, n):
    """ Byte search function.
...
plt.plot(np.arange(3000, 4200), traces[20][3000:4200], linewidth=0.2)
plt.show()

plt.plot(traces[10], linewidth=0.2)
plt.show()
...
for trace in traces[1:]:
    diff = 0
    min_sad = 10005000000000

    for i in range(start_range, end_range):
        if i + len_window > end_range:
            break
...
# tmp_end = 4000
# for i in range(20):
#     plt.plot(np.arange(tmp_start, tmp_end), traces[i][tmp_start:tmp_end] + i, linewidth=0.2)
# plt.show()
#
# for i in range(20):
#     plt.plot(np.arange(tmp_start, tmp_end), traces[i][tmp_start+diffs[i]:tmp_end+diffs[i]] + i, linewidth=0.2)
# plt.show()
