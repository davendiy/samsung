...
rConstants2 = [0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36]
...
def inv_key_schedule(last_key: np.ndarray):
    w = np.zeros((N * NROUNDS, 4), int)
    w[N * NROUNDS - 4:] = last_key.reshape(N, 4)
    res_key = np.zeros((N, 4), int)
